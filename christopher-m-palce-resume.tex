...
\item
	...
	\begin{itemize}
        \resitem{Expands and maintains internal web application and scripts used to monitor the health status of company's customer products/services.}
		\resitem{Rewrite legacy web application that contributed in the tool's increased reliabilty and productivity.}
...
\begin{description}
\item[Languages:]
PHP, Javascript/NodeJS, Java in Android
\item[Database:]
SQL
